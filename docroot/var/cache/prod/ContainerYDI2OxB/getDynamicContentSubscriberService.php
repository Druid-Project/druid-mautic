...
class getDynamicContentSubscriberService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $d = ($container->services['Mautic\\CoreBundle\\Model\\AuditLogModel'] ?? $container->getAuditLogModelService());
        ...
        $h = ($container->services['Mautic\\LeadBundle\\Model\\CompanyModel'] ?? $container->getCompanyModelService());

        if (isset($container->services['Mautic\\DynamicContentBundle\\EventListener\\DynamicContentSubscriber'])) {
            return $container->services['Mautic\\DynamicContentBundle\\EventListener\\DynamicContentSubscriber'];
        }

        return $container->services['Mautic\\DynamicContentBundle\\EventListener\\DynamicContentSubscriber'] = new \Mautic\DynamicContentBundle\EventListener\DynamicContentSubscriber($a, ($container->services['mautic.page.helper.token'] ?? $container->getMautic_Page_Helper_TokenService()), ($container->services['Mautic\\AssetBundle\\Helper\\TokenHelper'] ?? $container->getTokenHelperService()), $b, $c, $d, $e, $f, ($container->services['mautic.security'] ?? $container->getMautic_SecurityService()), $g, $h);
    }
}
