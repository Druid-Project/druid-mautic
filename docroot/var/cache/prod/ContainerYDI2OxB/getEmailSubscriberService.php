...
class getEmailSubscriberService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['MauticPlugin\\GrapesJsBuilderBundle\\EventSubscriber\\EmailSubscriber'] = new \MauticPlugin\GrapesJsBuilderBundle\EventSubscriber\EmailSubscriber(($container->services['grapesjsbuilder.config'] ?? $container->load('getGrapesjsbuilder_ConfigService')), $a, $b, ($container->services['Mautic\\EmailBundle\\Helper\\EmailConfig'] ?? $container->load('getEmailConfigService')));
    }
}
