...
class __TwigTemplate_886e9a2d24cf9a5efedfe2a0e15e827b extends Template
{
...
.button-variant(@background, @text-color, @border-color, @hover-background, @hover-text-color, @active-background, @disabled-background, @disabled-text-color) {
  ...
  fieldset[disabled] & {
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/css/app/less/mixins.less", "/app/docroot/app/bundles/CoreBundle/Assets/css/app/less/mixins.less");
    }
}
