...
class __TwigTemplate_38b2ad52a02cc3d9ea409db8b9f8cfa2 extends Template
{
...
.label {
  ...
  // Sizes
  &[size=\"sm\"] { height: 18px; padding: 0 var(--spacing-03); }
  &[size=\"md\"] { height: 24px; padding: 0 var(--spacing-03); }
  &[size=\"lg\"] { height: 32px; padding: 0 var(--spacing-04); }
...
.label-danger {
  ...
  color: var(--text-inverse);
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/css/app/less/components/labels.less", "/app/docroot/app/bundles/CoreBundle/Assets/css/app/less/components/labels.less");
    }
}
