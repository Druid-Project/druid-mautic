...
class __TwigTemplate_af9053ea97f3aea8fde4791214486d51 extends Template
{
...
.search-container {
  ...
  .search {
    border: none;
    background-color: transparent !important; // JS libraries apply inline styles, showing a weird rectangle background behind the icon.
    position: absolute;
    left: 0px;
    width: 24px;
    height: 34px;
...
";
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/css/app/less/components/forms.less", "/app/docroot/app/bundles/CoreBundle/Assets/css/app/less/components/forms.less");
    }
}
