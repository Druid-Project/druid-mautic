...
class __TwigTemplate_6b90c7b10b418d3e580b423bb9b34169 extends Template
{
...
.footer-buttons {
  ...
  &:has(.btn:nth-child(2)):not(:has(.btn:nth-child(3))) .btn { flex-grow: 0.5; }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/css/app/less/components/buttons.less", "/app/docroot/app/bundles/CoreBundle/Assets/css/app/less/components/buttons.less");
    }
}
