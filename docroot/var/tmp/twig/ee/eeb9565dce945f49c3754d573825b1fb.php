...
class __TwigTemplate_0b900540035584db91151e79639853dc extends Template
{
...
<div ";
  ...
  ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 186, $this->source); })()), "showLabel", [], "any", false, false, false, 186)) {
            ...
            $context = array_intersect_key($context, $_parent) + $_parent;
            yield ">";
            yield $this->env->getRuntime('Exercise\HTMLPurifierBundle\Twig\HTMLPurifierRuntime')->purify(CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 186, $this->source); })()), "label", [], "any", false, false, false, 186));
            yield "</h3>";
        }
        // line 187
        yield "  <div ";
...
";
    ...
    {
        return new Source("", "@MauticForm/Field/freetext.html.twig", "/app/docroot/app/bundles/FormBundle/Resources/views/Field/freetext.html.twig");
    }
}
