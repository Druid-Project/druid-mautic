...
class __TwigTemplate_54b29c95d17f30c8cfe0c74f151b2182 extends Template
{
...
$context["item"], "id", [], "any", false, false, false, 71), "objectAction" => "preview"])], "btnText" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.notification.mobile_notification.preview"), "iconClass" => "ri-share-forward-box-fill"]]]);
                // line 77
                yield "
                    </td>
                    <td>
...
(isset($context["limit"]) || array_key_exists("limit", $context) ? $context["limit"] : (function () { throw new RuntimeError('Variable "limit" does not exist.', 119, $this->source); })()), "baseUrl" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mautic_mobile_notification_index"), "sessionVar" => "mobile_notification"]);
            // line 122
            yield "
    </div>
";
...
";
    ...
    {
        return new Source("", "@MauticNotification/MobileNotification/_list.html.twig", "/app/docroot/app/bundles/NotificationBundle/Resources/views/MobileNotification/_list.html.twig");
    }
}
